...
function_pointing_table_file = open(parent_folder_path + "/Machine_Twin 1/FunctionPointingConfig.txt")
...
function_available_table_file = open(parent_folder_path + "/Machine_Twin 1/AvailableFunctions.txt")
...
ActiveFunctionsList = open(parent_folder_path + "/Machine_Twin 1/ActiveFunctionsList.txt")
...
paths_dictionary = {}
paths_dictionary['agent_functions_path'] = parent_folder_path + '/Machine_Twin 1/DownloadableFunctions'
paths_dictionary[
    'active_conversations_path'] = parent_folder_path + "/Machine_Twin 1/Conversation_Logs/active_conversations"
paths_dictionary[
    'ended_coversations_path'] = parent_folder_path + "/Machine_Twin 1/Conversation_Logs/ended_conversations"
paths_dictionary[
    'active_functions_configuration'] = parent_folder_path + "/Machine_Twin 1/active_functions_config.txt"
paths_dictionary['agents_directory'] = parent_folder_path + "/Machine_Twin 1/agents_directory"
paths_dictionary['database'] = parent_folder_path + "/Machine_Twin 1/DataBase"
...
with open(parent_folder_path+'/hmi_ip.txt') as f:
    lines=[]
...
def register_twin(msg):
    meta_filepath = parent_folder_path + "/Machine_Twin 1/MachineCommunication/agent_metadata.json"
...
def connect_twin(msg):
    meta_filepath = parent_folder_path + "/Machine_Twin 1/MachineCommunication/agent_metadata.json"
    folder_track = parent_folder_path + "/Machine_Twin 1/MachineCommunication"
