...
class EstablishConnection(QThread):
    ...
    def run(self):
        ...
        sys.path.append(parent_dir+"/notifieragent")
        # import socketdll
...
"background-color: rgb(92, 190, 255);")
        ...
        self.server_button.clicked.connect(self.machine_initialization)
        ...
        self.Platform.setObjectName("Connect")
        # Mapping of Platform button to platform_click function
        self.Platform.clicked.connect(self.socket_click)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.server_button.setText(_translate("MainWindow", "Activate Twin"))
        self.Platform.setText(_translate("MainWindow", "Connect"))
